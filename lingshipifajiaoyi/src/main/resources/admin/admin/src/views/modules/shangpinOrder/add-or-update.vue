    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派送人姓名" prop="shangpinOrderCourierName">
                       <el-input v-model="ruleForm.shangpinOrderCourierName"
                                 placeholder="派送人姓名" clearable  :readonly="ro.shangpinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派送人姓名" prop="shangpinOrderCourierName">
                           <el-input v-model="ruleForm.shangpinOrderCourierName"
                                     placeholder="派送人姓名" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="派送人联系方式" prop="shangpinOrderCourierNumber">
                       <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                 placeholder="派送人联系方式" clearable  :readonly="ro.shangpinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="派送人联系方式" prop="shangpinOrderCourierNumber">
                           <el-input v-model="ruleForm.shangpinOrderCourierNumber"
                                     placeholder="派送人联系方式" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinOrderCourierName: [
                              { required: true, message: '派送人姓名不能为空', trigger: 'blur' },
                          ],
                   shangpinOrderCourierNumber: [
                              { required: true, message: '派送人联系方式不能为空', trigger: 'blur' },
                          ],
                   shangpinOrderTypes: [
