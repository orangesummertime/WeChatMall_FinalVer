<template>
    <div class="main-content">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lingshipifajiaoyi/upload/shangpinOrderMuBan.xls"
                        >批量导入商品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 1 && sessionTable=='yonghu' && userId==scope.row.yuangongId" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 1 && sessionTable=='yuangong'" type="primary" icon="el-icon-reading" size="mini"
                                       @click="deliver(scope.row.id)"
                                        >发货</el-button>


                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && sessionTable=='yonghu' && userId==scope.row.yuangongId" type="primary" icon="el-icon-reading" size="mini" @click="receiving(scope.row.id)">收货</el-button>

                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 4 && sessionTable=='yonghu' && userId==scope.row.yuangongId" type="primary" icon="el-icon-reading" size="mini" @click="openCommentModel(scope.row.id)">评价</el-button>
        ...
        <el-dialog title="销售分布图" :visible.sync="chartVisiable" width="80%">
            <el-date-picker
                    v-model="echartsDate"
                    type="month"
                    placeholder="选择月">
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     ...
                     '派送人姓名': "shangpinOrderCourierName",
                     '派送人联系方式': "shangpinOrderCourierNumber",
            ...
            chartDialog() {
                ...
                this.$nextTick(()=>{
                    ...
                    let params = {
                        ...
                        sumColumn: "buy_number",
                        groupColumn: "shangpin_name",
