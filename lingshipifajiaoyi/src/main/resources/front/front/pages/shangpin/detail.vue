				...
				<view class="bottom-content cu-bar bg-white tabbar border shop">
					<view style="width: 100%;margin: 0 auto;display: flex;align-items: center;justify-content: space-around;">
						<view style="width: 30%;display: flex;align-items: center;flex-wrap: wrap;justify-content: space-evenly;">
								...
								<!-- 购物车 -->
								<uni-icons style="color: var(--publicMainColor);" type="cart" size="30" @tap="goCart"></uni-icons>
						</view>
		...
		export default {
			...
			methods: {
				...
				async init() {
					...
					this.detail.shangpinContent = this.detail.shangpinContent.replaceAll("<img","<img  class=\"daxiao\"").replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
