    ...
    <view class="content">
        <form class="app-update-pv">
            ...
            <view
                ...
                <input   disabled
                         :style='{"padding":"0 30rpx","boxShadow":"0 8rpx 0px 4rpx var(--publicMainColor)","margin":"0","borderColor":"rgba(0,0,0,.6)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"20rpx 20rpx 0 0","borderWidth":"0","fontSize":"28rpx","borderStyle":"solid","height":"60rpx"}'
                         :disabled="ro.yuangongEmail" type="text" v-model="ruleForm.yuangongEmail" placeholder="电子邮箱"></input>
            </view>
    ...
    export default {
        ...
        methods: {
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.yuangongEmail) && (!this.$validate.isEmail(this.ruleForm.yuangongEmail))) {
