    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="商品库存/箱" prop="shangpinKucunNumber">
                        <el-input v-model="shangpinForm.shangpinKucunNumber"
                                  placeholder="商品库存/箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="商品库存/箱" prop="shangpinKucunNumber">
                            <el-input v-model="ruleForm.shangpinKucunNumber"
                                      placeholder="商品库存/箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12" v-if="type=='info'">
                   <div >
                       <el-form-item class="input" label="盘点前数量" prop="shangpinPandianQianNumber">
                           <el-input v-model="ruleForm.shangpinPandianQianNumber"
                                     placeholder="盘点前数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="盘点数量" prop="shangpinPandianHouNumber">
                       <el-input v-model="ruleForm.shangpinPandianHouNumber"
                                 placeholder="盘点数量" clearable  :readonly="ro.shangpinPandianHouNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="盘点数量" prop="shangpinPandianHouNumber">
                           <el-input v-model="ruleForm.shangpinPandianHouNumber"
               ...
               <el-col :span="12" v-if="type=='info'">
                   <div v-if="type=='info'">
                       <el-form-item class="input" label="差数量" prop="shangpinPandianChaNumber">
                           <el-input v-model="ruleForm.shangpinPandianChaNumber"
                                     placeholder="差数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="盘点备注" prop="shangpinPandianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shangpinPandianContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinPandianContent" label="盘点备注" prop="shangpinPandianContent">
                            <span v-html="ruleForm.shangpinPandianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinPandianQianNumber: [
                              { required: true, message: '盘点前数量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinPandianChaNumber: [
                              { required: true, message: '差数量不能为空', trigger: 'blur' },
                          ],
                   shangpinPandianContent: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shangpinPandianContent = _this.ruleForm.shangpinPandianContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shangpinPandianContent = this.ruleForm.shangpinPandianContent.replaceAll(this.$base.url,"");
                        this.$http({
