                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lingshipifajiaoyi/upload/shangpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="商品库存/箱">
                        <template slot-scope="scope">
                          <span :style="scope.row.shangpinKucunNumber<11?'color: red':''">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">增加商品库存/箱</el-button>-->
                            <!--<el-button v-if="isAuth('shangpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceShangpinKucunNumber(scope.row.id,scope.row.shangpinKucunNumber)">减少商品库存/箱</el-button>-->
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
			...
			//数据不为空放值
				...
				//标题
				this.shangpinKucunNumberTitle = '增加商品库存/箱'
			},
			//减少商品库存/箱
			...
			//数据不为空放值
				...
				this.shangpinKucunNumberVisible = true;
				//标题
				this.shangpinKucunNumberTitle = '减少商品库存/箱'
			},
			//提交用户操作商品库存/箱数量
			addShangpinKucunNumber(){
				...
				if(this.kucunNumberTypes == "+"){
					...
					if(this.shangpinKucunNumber < this.kucunNumber || this.kucunNumber <= 0){
						this.$message.error('商品库存/箱不足不能减少');
						return false;
					}else{
						maxNumber = this.shangpinKucunNumber - this.kucunNumber
					}
