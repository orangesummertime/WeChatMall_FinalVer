	...
	<script>
		export default {
			...
			async onLoad(options) {
				this.shangpinPandianId = options.id;
			},
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.info('shangpinPandian', this.shangpinPandianId);
                    this.detail = res.data
					this.detail.shangpinPandianContent = this.detail.shangpinPandianContent.replaceAll("<img","<img  class=\"daxiao\"").replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
					this.swiperList = this.detail.shangpinPandianPhoto ? this.detail.shangpinPandianPhoto.split(",") : [];
				},
